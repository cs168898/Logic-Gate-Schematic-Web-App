...
// Purpose: This is an entity class that maps to the user_details table in the database. 
// It represents the user data that will be stored and retrieved from the database.
